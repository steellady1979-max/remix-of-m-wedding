...
const couple = { url: "/images/hero-palace-gates.webp" };
...
const HOME_MAP = "https://www.google.com/maps?q=42.499073,41.888233";
const DINNER_MAP =
...
const SCHEDULE = [
  ...
  },
  {
    ...
    href: HOME_MAP,
    image: "/images/guest-reception-home.webp",
    alt: "სტუმრების მისაღები სახლის აკვარელის ნახატი",
    width: 879,
    height: 1024,
  },
  {
...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preload", as: "image", href: "/images/hero-palace-gates.webp" },
    ],
  }),
  component: Index,
});
      ...
      >
        ...
        <section className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden px-6 text-center lg:grid lg:grid-cols-2 lg:items-stretch lg:gap-0 lg:px-0 lg:text-left">
          ...
          <div className="relative animate-fade-in rounded-xl bg-white/70 px-8 py-10 backdrop-blur-[2px] lg:col-start-1 lg:row-start-1 lg:flex lg:h-full lg:flex-col lg:items-center lg:justify-center lg:rounded-none lg:bg-champagne lg:px-16 lg:text-center lg:backdrop-blur-none">
            <p className="text-sm tracking-normal text-olive sm:tracking-normal">
            ...
            <p className="mt-6 text-sm tracking-normal text-ink/70 lg:text-base">22 · 09 · 2026</p>
          </div>
        </section>
        ...
        <section className="flex flex-col items-center gap-8 bg-olive-mist px-6 py-24 text-center lg:py-32">
          <Reveal>
            <p className="text-sm tracking-normal text-olive">დარჩენილია</p>
        ...
        <section className="flex flex-col items-center gap-10 bg-olive-mist px-6 py-24 lg:gap-16 lg:py-32">
          <Reveal>
            <p className="text-sm tracking-normal text-olive">დღის განრიგი</p>
          </Reveal>
              ...
              >
                <li className="flex h-full flex-col items-center gap-5 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    {item.venue && (
                      <p className="text-base font-semibold leading-relaxed text-olive">
                        {item.venue}
                      </p>
                    )}
                  </div>
                  ...
                  {item.href && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="mt-auto rounded-md border border-olive/30 px-5 py-2 text-xs tracking-normal text-olive transition-colors hover:bg-olive hover:text-white"
                    >
                      რუკაზე გადასვლა
                    </a>
                  )}
          ...
          <div className="mx-auto grid w-full max-w-5xl items-center gap-10 md:grid-cols-2 md:gap-14 lg:gap-20">
            ...
            <Reveal delay={120} className="flex flex-col items-center md:items-start md:text-left">
              ...
              <p className="mt-6 max-w-xl text-[0.95rem] leading-8 text-ink/75 sm:text-base lg:text-lg lg:leading-9">
                ...
                ატმოსფეროს მოუხდება. თეთრი ფერი დავუთმოთ პატარძალს ✨
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <section className="flex flex-col items-center gap-8 bg-olive-mist px-6 py-24 text-center lg:py-32">
          <Reveal>
            ...
            <p className="text-sm tracking-normal text-olive">სურვილები</p>
            <h2 className="mt-4 font-display text-2xl font-light text-olive sm:text-3xl lg:text-4xl">
              სურვილების კონვერტი
            </h2>
          </Reveal>
        ...
        <footer className="bg-olive px-6 py-12 text-center">
          ...
          <p className="mt-2 text-sm tracking-normal text-white/70">22 სექტემბერი 2026</p>
        </footer>
      </div>
    </main>
  );
